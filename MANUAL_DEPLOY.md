...
- `SSO_SECRET` � deve ser **id�ntico** ao `JWT_SECRET` do backend de chamados. Com ele, o SCE aceita os access tokens JWT emitidos pelo portal (usu�rio resolvido por e-mail na tabela `usuarios` local; n�vel/filial continuam vindo do SCE).
